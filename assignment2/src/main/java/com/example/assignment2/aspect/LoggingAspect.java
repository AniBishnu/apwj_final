package com.example.assignment2.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.example.assignment2.Controller..*(..)) || " +
            "execution(* com.example.assignment2.Service..*(..)) || " +
            "execution(* com.example.assignment2.Repository..*(..))")
